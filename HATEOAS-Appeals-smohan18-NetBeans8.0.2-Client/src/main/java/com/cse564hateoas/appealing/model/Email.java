...
public class Email {
    ...
    Email(){LOG.info("Default constructor of Email server");}
    ...
    {
    this.email_body="Dear Professor Callis, \n Appeal has been updated for . New Attachment has been added. Please review and do the needful, Thanks, \n Siddharth Sujir Mohan";
    }
    public void updateAttachment(String attachment)
    {
    this.attachment=attachment;
    }
