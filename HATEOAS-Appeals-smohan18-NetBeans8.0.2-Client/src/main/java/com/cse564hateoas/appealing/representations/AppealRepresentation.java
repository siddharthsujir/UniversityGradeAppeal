    ...
    public Appeal getAppeal() {
        ...
        //for (Item i : items) {
          ...
          //  }
            ...
            Appeal appeal2 = new Appeal(items, status);
        Email email2 = new Email("smohan18@asu.edu", "Siddharth Sujir Mohan","callis@asu.edu", "Appeal 1207654769", "Appeal Body", "1.jpg");
        appeal2.setEmail(email2);
