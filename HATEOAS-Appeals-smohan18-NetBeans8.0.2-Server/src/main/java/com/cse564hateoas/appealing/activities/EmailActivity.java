...
public class EmailActivity {
    public EmailRepresentation pay(Email email, AppealUri emailUri) {
        ...
        // Business rules - if the email amount doesn't match the amount outstanding, then reject
      /*  if(AppealRepository.current().get(identifier).calculateCost() != email.getSenderEmail()) {
